...
local/plda_scoring.sh data/train data/train data/test \
  exp/ivectors_train exp/ivectors_train exp/ivectors_test $trials local/scores_gmm_${num_components}_ind_pooled
local/plda_scoring.sh --use-existing-models true data/train data/train_female data/test_female \
  exp/ivectors_train exp/ivectors_train_female exp/ivectors_test_female $trials_female local/scores_gmm_${num_components}_ind_female
local/plda_scoring.sh --use-existing-models true data/train data/train_male data/test_male \
  exp/ivectors_train exp/ivectors_train_male exp/ivectors_test_male $trials_male local/scores_gmm_${num_components}_ind_male
...
local/plda_scoring.sh data/train_female data/train_female data/test_female \
  exp/ivectors_train exp/ivectors_train_female exp/ivectors_test_female $trials_female local/scores_gmm_${num_components}_dep_female
local/plda_scoring.sh data/train_male data/train_male data/test_male \
  exp/ivectors_train exp/ivectors_train_male exp/ivectors_test_male $trials_male local/scores_gmm_${num_components}_dep_male

mkdir -p local/scores_gmm_${num_components}_dep_pooled
cat local/scores_gmm_${num_components}_dep_male/plda_scores local/scores_gmm_${num_components}_dep_female/plda_scores \
  > local/scores_gmm_${num_components}_dep_pooled/plda_scores
