...
for x in 0 1 2; do
 ...
 steps/train_deltas.sh --cmd "$train_cmd" \
  1800 9000 data/train data/lang exp/mono_ali_one exp/tri1_clu3_monoone_v1/tri1_clu$x
 local/train_deltas_v1.sh --cmd "$train_cmd" --stage 1\
  1800 9000 data/train_clu3/train_clu$x data/lang exp/mono_ali_one exp/tri1_clu3_monoone_v1/tri1_clu$x
 utils/mkgraph.sh data/lang exp/tri1_clu3_monoone_v1/tri1_clu$x exp/tri1_clu3_monoone_v1/tri1_clu$x/graph
 steps/decode.sh --config conf/decode.config --nj 20 --cmd "$decode_cmd" \
   exp/tri1_clu3_monoone_v1/tri1_clu$x/graph data/test_clu3/test_clu$x exp/tri1_clu3_monoone_v1/tri1_clu$x/decode
